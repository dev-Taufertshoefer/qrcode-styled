const DataStyling = require('./basicStyling');

exports.styleData = function qrToImageData (imgData, allInfos) {
    
    imgData.fill(255)

    DataStyling.positionMarkerStyling(imgData, allInfos);
    DataStyling.dataAreaStyling(imgData, allInfos);
...
exports.findCoordOfOddPixelFlanksRechtangle = function findCoordOfOddPixelFlanksRechtangle(width, height) {
  ...
  resultObj.x = Math.ceil(width/2);
  resultObj.y = Math.ceil(height/2);

  resultObj.abs = width * resultObj.x + resultObj.y
