...
exports.qrToImageData = function qrToImageData (imgData, allInfos) {
    ...
    // if(toImageDataOpts.image.length)  Styling.insertImage(imgData, toImageDataOpts.image);
    return imgData;
...
exports.getImageWidth = function getImageWidth (qrSize, width, margin, scale) {
    var scale = exports.getScale(qrSize, width, margin, scale)
...
exports.getStyleInfo = function getStyleInfo(resQR, styledOpts) {
    ...
    if(typeof moduleStyle === 'undefined' || !moduleStyle) {
      ...
      moduleStyle.colordark = '#000000ff',
      moduleStyle.colorlight = '#ffffffff'
    }
    ...
    if(typeof positionMarker === 'undefined' || !positionMarker) {
      ...
      positionMarker.squareColor = '#000000ff',
      positionMarker.innerType = 'none', // 'dot', 'square', 'none'
      positionMarker.innerColor= '#000000ff'
